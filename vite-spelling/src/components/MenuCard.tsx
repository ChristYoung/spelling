...
export const MenuCard: React.FC<MenuCardProps> = (props: MenuCardProps) => {
    ...
    return (
        <a className="cursor-pointer text-left">
            <span className="group transition-bg duration-250 ease-out delay-0 w-[238px] relative block m-0 rounded-[0.8rem] py-6 px-8 overflow-hidden bg-little-dark hover:bg-transparent">
