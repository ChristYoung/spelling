...
import {
  ...
  useIsFocusVisible,
  useThemeProps
} from "./chunk-DSXWYDPK.js";
import "./chunk-HYTHURNT.js";
import {
  require_react_dom
...
var _excluded4 = ["className", "color", "edge", "size", "sx"];
...
var Switch = React13.forwardRef(function Switch2(inProps, ref) {
  ...
  const icon = (0, import_jsx_runtime7.jsx)(SwitchThumb, {
    className: classes.thumb,
    ownerState
  });
  return (0, import_jsx_runtime8.jsxs)(SwitchRoot, {
    className: clsx_default(classes.root, className),
    sx,
    ownerState,
    children: [(0, import_jsx_runtime7.jsx)(SwitchSwitchBase, _extends({
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    })), (0, import_jsx_runtime7.jsx)(SwitchTrack, {
